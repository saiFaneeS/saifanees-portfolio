...
const contact = () => {
  return (
    <Layout>
      <div className="h-screen overflow-hidden relative flex flex-col justify-center gap-8 px-24">
        <div className="h-full w-full flex flex-col justify-center mt-20">
          ...
          <div className="flex justify-between items-center gap-8">
            <div className="flex gap-6 items-center">
              ...
              <Link href={"/"} className="text-lg font-medium">saifanees11@gmail.com</Link>
            </div>
            <div className="flex gap-6 items-center">
